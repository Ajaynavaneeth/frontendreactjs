...
class CreateEmployeeComponent extends Component {
    ...
    getTitle(){
        if(this.state.id === '_add'){
            return <h3 className="text-center p-4 m-2 text-info">Insert</h3>
        }
        else{
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3 cardshadow3">
                                ...
                                <div className = "card-body">
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <button onClick={this.saveOrUpdateEmployee}><BsCheckCircleFill/> Save</button>
                                        <button  onClick={this.cancel.bind(this)} style={{marginLeft: "10px"}}><BsFillXCircleFill/> Discard</button>
                                        </div> 
                                    </form>
                                </div>
                            </div>
